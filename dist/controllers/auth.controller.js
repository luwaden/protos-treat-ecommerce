...
import { setRefreshTokenCookie, clearRefreshTokenCookie, REFRESH_COOKIE_NAME, } from "../utils/cookie.utils.js";
 ...
 */
async function issueTokenPair(payload, res) {
...
class AuthController {
    ...
    resetPassword = async (req, res, next) => {
        try {
            ...
            if (!record)
                throw new AppError("Invalid or expired reset link. Please start again.", 400);
